...
export interface ApiBlogAuthorBlogAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog author content type for managing blog post authors';
...
export interface ApiBlogCategoryBlogCategory
  ...
  info: {
    description: 'Blog category content type for organizing blog posts';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog post content type for managing blog articles';
